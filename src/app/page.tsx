  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10 print:py-6">
      ...
      <div className="text-center min-h-[70vh] flex flex-col justify-center">
        ...
        {/* Logo placeholder */}
        <div className="w-48 h-48 mx-auto mb-8 rounded-full border-4 border-[#D4AF37] bg-gradient-to-br from-[#8B0000] to-[#5C0000] flex items-center justify-center shadow-xl print:shadow-none">
        ...
        <h1 className="text-6xl md:text-7xl font-bold text-[#8B0000] mb-4 font-serif">
          Chada Thai
        </h1>
        <p className="text-xl text-[#5C0000] tracking-[0.3em] uppercase mb-6">Lynnwood</p>
        ...
        <p className="text-lg text-gray-600 max-w-lg mx-auto font-serif italic">
      ...
      <div className="mt-16 print:mt-8">
        <h2 className="text-2xl font-bold text-[#8B0000] text-center mb-8 font-serif">
          Menu
        </h2>
